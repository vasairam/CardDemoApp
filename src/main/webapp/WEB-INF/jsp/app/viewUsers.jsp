...
>
  <head>
    ...
    <title>View USERS | CARD DEMO </title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
		  ...
		  <div class="content-wrapper">
			...
			<h4 class="fw-bold "><span class="text-muted fw-light">Users /</span> View </h4>
             <!--<div class="row"> -->
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
					...
					<%  ArrayList<User> data =  (ArrayList)request.getAttribute("userData");;
					 ...
					 <td>
						...
						<td><span class="badge bg-label-warning me-1"><%=data.get(i).getRole()%></span></td>
