...
>
  <head>
    ...
    <title> Update User | Card Demo </title>
	 ...
	 <script>
	  function updateUser() {
       // alert("called");
            ...
            request.open("POST","/updateUserPOST");
            request.send(data);
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
		  ...
		  <div class="content-wrapper">
			...
			<h4 class="fw-bold "><span class="text-muted fw-light">User /</span> Update</h4>
              <div class="row">
                    ...
                    <div class="card-body">
                      <form id="updateUser" class="row g-3"  action="updateUserPOST" method ="POST">
                        ...
                        <input
                          ...
                          aria-describedby="basic-addon-search31" name="username" id="username" onblur="return fetchUser()"/>
                      </div>
                        </div>
						...
						<div class="col-4">		
                          <button type="button" onclick="return updateUser()" name="submitButton" class="btn btn-primary">Update User</button>
                        </div>
                       </form>
                    </div>
                  </div>
