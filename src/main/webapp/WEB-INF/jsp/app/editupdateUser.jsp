                    ...
                    <div class="card-body">
                      <form id="updateUser" class="row g-3"  action="updateUserPOST" method ="POST">
                        ...
                        <input
                          ...
                          aria-describedby="basic-addon-search31" name="username" id="email" onblur="return fetchUser1()" />
                      </div>
                        </div>
						...
						<div class="col-4">		
                          <button type="submit" name="submitButton" class="btn btn-primary">Update User</button>
                        </div>
                       </form>
                    </div>
                  </div>
